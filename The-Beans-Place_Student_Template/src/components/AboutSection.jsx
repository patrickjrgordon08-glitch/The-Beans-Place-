...
const values = [
    ...
    icon: "🌎",
    title: "Direct Trade Origins",
    description: "We partner directly with small farms in Ethiopia, Colombia, Guatemala and Indonesiaa. Every bag is fully traceable to the farm it came from." ,
    },
    {
    icon: "☕",
    title: "Small-Batch Roasting",
    description: "Our master roaster profiles every bean to unlock its peak flavor. We roast in 25lbs batches for consistency and freshness   you can taste.",
    },
    {
    icon: "🚚",
    title: "Direct Trade Origin",
description: "We don't pre-roast and shelve. Your beans are roasted after you order and shipped within 48 hours. Free delivery on orders over $50.",
}
];
...
export default function AboutSection() {
    return (
        ...
        {/* Two Colomn story with Image */}

<div className="about-story-grid">
    <ScrollReveal animation="fadeLeft" className="about-story-text">
        <p className="about-body lead--light">
            The Beans Place started in 2012 with one simple belief; great coffee shpuld br accesssible to everyone- not just aficionados. We work directly with farming corperatives across four continents, paying above fair-trade prices to ensure quality from soil to sip.
        </p>

    <p className="about-body lead--light">
       Every week, our roastmaster cups dozzen of samples to select only the lots that meet ouer standards. Whether you prefer a bright, fruity Ethiopian Yiragacheffe or a deep, chocolately Columbian Supremo, we roast each batch to order so it arrives at peak freshness. 
    </p>
